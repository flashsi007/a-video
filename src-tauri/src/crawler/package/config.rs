...
pub const USER_AGENTS: &[&str] = &[
    ...
    "Mozilla/5.0 (iPhone; CPU iPhone OS 16_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/114.0.0.0 Mobile/15E148 Safari/604.1",
    ...
    "Mozilla/5.0 (Linux; Android 13; Pixel 7) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Mobile Safari/537.36"
];

pub const PROXY_POOL: &[&str] = &[
    // 示例代理地址，实际使用时请替换为可用代理  
